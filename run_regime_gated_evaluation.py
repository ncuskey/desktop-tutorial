...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--adx-slope-threshold", type=float, default=-0.2)
    parser.add_argument("--atr-expansion-threshold", type=float, default=1.0)
    parser.add_argument(
        "--atr-expansion-recent-window",
        "--expansion-recent-window",
        dest="expansion_recent_window",
        type=int,
        default=12,
    )
    parser.add_argument("--compression-threshold", type=float, default=0.05)
...
def main() -> None:
    ...
    artifacts = run_regime_gated_evaluation(
        ...
        gating_params={
            ...
            "atr_expansion_recent_window": args.expansion_recent_window,
